    ...
    <div class="p-6">
        ...
        <form method="POST" action="{{route('updateEvent')}}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="event-name" name="nom" placeholder="Enter event name" value="{{$data->nom}}" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
            </div>

            <!-- Event Description -->
            <div class="mb-4">
                <label for="event-description" class="block text-sm font-medium text-gray-700 mb-1">Event Description</label>
                <textarea id="event-description" name="description" placeholder="Enter event description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">{{$data->description}}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="event-place" name="place" placeholder="Enter event place" value="{{$data->place}}" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
            </div>

            <!-- Event Date and Time -->
            <div class="mb-4">
                <label for="event-date" class="block text-sm font-medium text-gray-700 mb-1">Event Date and Time</label>
                <input type="datetime-local" id="event-date" name="date" value="{{$data->date}}" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
            </div>

            <!-- Event Capacity -->
            <div class="mb-4">
                <label for="event-capacity" class="block text-sm font-medium text-gray-700 mb-1">Event Place Capacity</label>
                <input type="number" id="event-capacity" name="numberOfPlace" value="{{$data->numberOfPlace}}" placeholder="Enter number of available places" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
            </div>

            <!-- Event Price -->
            <div class="mb-6">
                <label for="event-price" class="block text-sm font-medium text-gray-700 mb-1">Event Price</label>
                <input type="text" id="event-price" name="taketPrice" placeholder="Enter Price" value="{{$data->taketPrice}}" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
            </div>

            <!-- Event stockeTicket -->
            <div class="mb-6">
                <label for="event-stockeTicket" class="block text-sm font-medium text-gray-700 mb-1">Event stockeTicket</label>
                <input type="text" id="event-stockeTicket" name="stockeTicket" value="{{$data->stockeTicket}}" placeholder="Enter stockeTicket" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
            </div>
