...
<body class="flex flex-col min-h-screen bg-gray-100">
    ...
    <!-- Sidebar -->
    <aside id="sidebar" class="w-60 bg-[#7A38FC] text-white fixed top-0 left-0 h-screen overflow-y-auto z-40 -translate-x-full lg:translate-x-0 transition-transform duration-300">
